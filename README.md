...
* **💧 포인트 적립 및 상점 (Shop & Points)**
  * 걸음 수에 비례하여 자동으로 물방울(포인트)이 적립됩니다. (100보당 1 물방울)
  * 상점에서 모자, 안경, 배경 등 다양한 아이템을 구매하고 나만의 귀여운 슬라임을 꾸밀 수 있습니다.
  * 아이템 장착 및 장착 해제 기능과 내가 보유한 아이템을 확인할 수 있는 **구매 내역 화면**을 제공합니다.
