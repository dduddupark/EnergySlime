...
class DetailScreen extends StatefulWidget {
  final String title;
  final String type; // 'calories' or 'active_time'
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Future<void> _loadWeeklyData() async {
    ...
    final startTime = DateTime(now.year, now.month, now.day).subtract(const Duration(days: 6));
    ...
    if (widget.type == 'calories' && computedMaxY < 500) {
      computedMaxY = 500;
    } else if (widget.type == 'active_time' && computedMaxY < 60) {
      computedMaxY = 60;
    }
  ...
  Widget build(BuildContext context) {
    ...
    final String unit = widget.type == 'calories' ? 'kcal' : 'min';
                      ...
                      LineChartData(
                        ...
                        titlesData: FlTitlesData(
                          ...
                          bottomTitles: AxisTitles(
                            sideTitles: SideTitles(
                              ...
                              getTitlesWidget: (value, meta) {
                                switch (value.toInt()) {
                                  case 0: return const Text('D-6');
                                  case 3: return const Text('D-3');
                                  case 6: return const Text('오늘');
                                }
                                return const Text('');
                              },
                            ),
                          ...
                          leftTitles: AxisTitles(
                            sideTitles: SideTitles(
                              showTitles: true,
                              interval: _maxY / 4 > 0 ? _maxY / 4 : 1, // Prevent interval 0
                              reservedSize: 40,
                              getTitlesWidget: (value, meta) {
